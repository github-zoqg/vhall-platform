  ...
  export default {
    ...
    methods: {
      ...
      addSDKEvents() {
        ...
        // 流加入
        this.insertFileServer.$on('INSERT_FILE_STREAM_ADD', e => {
        ...
        // 插播流删除 流结束
        this.insertFileServer.$on('INSERT_FILE_STREAM_REMOVE', e => {
        ...
        this.insertFileServer.$on('INSERT_FILE_STREAM_FAILED', e => {
