 ...
 * 设置上报基础属性
 * function
 * @param {Object} roomState Domain 房间信息集合
 */
export const setReportingBaseAttrs = roomState => {
  const { watchInitData = {} } = roomState;
  ...
  window.vhallReportForProduct.commonParams = {
    ...{
      ...
      language_type: roomState.languages.language_type,
